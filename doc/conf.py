...
latex_documents = [
    ('index', 'Existenz.tex', u'Existenz Documentation',
...
man_pages = [
    ('index', 'Existenz', u'Existenz Documentation',
     [u'Raul Gonzalez'], 1)
]
...
texinfo_documents = [
    ('index', 'k', u'Existenz Documentation',
     u'Raul Gonzalez', 'Existenz', 'Object of Knowledge.',
     'Miscellaneous'),
]
